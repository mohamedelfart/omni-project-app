...
const operator_policy_module_1 = require("../operator-policy/operator-policy.module");
...
exports.ServicesModule = ServicesModule = __decorate([
    (0, common_1.Module)({
        imports: [unified_requests_module_1.UnifiedRequestsModule, operator_policy_module_1.OperatorPolicyModule],
